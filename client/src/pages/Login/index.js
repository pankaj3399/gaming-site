...
const Login = () => {
    ...
    return (
        <div className="flex min-h-screen Login">
            <div className="w-full md:w-1/2 flex items-center section-1">
                <div className="w-full max-w-70 mx-auto px-4 py-15">
                    ...
                    <div className="text-center my-5">
                        <h1 className="text-24 font-medium">Sign in to Lemon Squeezy</h1>
                    </div>
                    ...
                    <div className="flex items-center justify-center mt-5">
                        <p className="mx-1">
                            <Link to='/reset-password' className="text-grey text-wtf-majorelle">Forgot your password?</Link>
                        </p>
                        <p className="mx-1">
                            <Link to='/register' className="text-grey text-wtf-majorelle">Sign up</Link>
                        </p>
                        <p className="mx-1">
                            <a href="#" className="text-grey text-wtf-majorelle">Customer Dashboard</a>
                        </p>
                    </div>
                </div>
            </div>
